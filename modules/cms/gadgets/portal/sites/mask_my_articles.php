...
//require_once ('../../../gadgets/inc/phpthumb/ThumbLib.inc.php');
require_once ('../../../gadgets/function.inc.php');
...
while ( $array = mysqli_fetch_array ( $sql ) ) {
	...
	if ($array ['date_booking'] != '0000-00-00') {
		...
		$content .= 
		"<div class='title'><i class='dropdown icon'></i>" . $array ['internet_inside_title'] . "</div>" . 
		"<div class='content'>" . $strNotJetUnlocked . "</div>";
	}
	$gallery = '';
}
...
if ($content)
	...
	echo "<div align=center><br><br>$strNoArticle<br><br></div>";