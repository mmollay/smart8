...
$type_field = "
<div class='ui calendar'id='$id' ><div class='ui input left icon'><i class='calendar icon'></i><input value='$value' name='$id' type='text' placeholder='$placeholder' ></div></div>";
