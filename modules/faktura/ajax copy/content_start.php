...
$setContent .= "<td align=center width=160 valign=top><a href=# onclick=\"load_content('faktura','list_earnings')\"><b>Einnahmen</b><br><br><img src='images/earning.png' height=85px></td>";
$setContent .= "<td align=center width=160 valign=top><a href=# onclick=\"load_content('faktura','list_client2')\"  ><b>Clienten</b><br><img src='images/client.png' height=110px></a></td>";
$setContent .= "<td align=center width=160 valign=top><a href=# onclick=\"load_content('faktura','list_article')\" ><b>Artikel</b><br><br><img src='images/article.png' height=90px></td>";
if ($show_menu['finance_output'])
	$setContent .= "<td align=center width=160 valign=top><a onclick=\"load_content('faktura','list_issues')\" ><b>Ausgaben</b><br><br><img src='images/outgoings.png' height=100p></td>";
