...
switch ($_POST ['list_id']) {
	...
	case 'client_oegt_list' :
		...
		// $check_company_1 = mysql_singleoutput ( "SELECT * FROM client WHERE company_id = '$company_id' AND company_1 = '$company_1' AND client_id != '{$_POST['update_id']}' ", "company_1" );
		// Clientnumber setzen
		// $check_client_number = mysql_singleoutput ( "SELECT client_number FROM client WHERE client_number='$client_number' AND client_id != '{$_POST['update_id']}' ", "client_number" );
		// $check_email = mysql_singleoutput ( "SELECT * FROM client WHERE email = '$email' AND company_id = '$company_id' ", "email" );
