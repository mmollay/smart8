...
$query = "
    SELECT 
        ...
        (SELECT parameter_value FROM trading_parameter_model_values 
         WHERE model_id = pm.id AND parameter_name = 'tp_percentage_long' LIMIT 1) as tp_percentage_long,
        (SELECT parameter_value FROM trading_parameter_model_values 
         WHERE model_id = pm.id AND parameter_name = 'sl_percentage_long' LIMIT 1) as sl_percentage_long,
        (SELECT parameter_value FROM trading_parameter_model_values 
        ...
        (SELECT parameter_value FROM trading_parameter_model_values 
         WHERE model_id = pm.id AND parameter_name = 'tp_percentage_short' LIMIT 1) as tp_percentage_short,
        (SELECT parameter_value FROM trading_parameter_model_values 
         WHERE model_id = pm.id AND parameter_name = 'sl_percentage_short' LIMIT 1) as sl_percentage_short
