...
<div class="ui grid">
    <div class="three wide column">
        <div class="ui vertical fluid menu">
            <a class="item" href="#" onclick="loadContent('content', 'lists/trades.php'); return false;">
                <i class="exchange icon"></i> Trades
            </a>
            <a class="item" href="#" onclick="loadContent('content', 'lists/pnl.php'); return false;">
                <i class="chart line icon"></i> PnL History
            </a>
            <a class="item" href="#" onclick="loadContent('content', 'lists/positions.php'); return false;">
                <i class="balance scale icon"></i> Positionen
            </a>
            <div class="item">
                <button class="ui fluid primary button" onclick="syncAll()">
                    <i class="sync icon"></i> Sync All
                </button>
            </div>
        </div>
    </div>
